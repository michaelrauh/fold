...
fn test_diagonal_calculation_2x2() {
    ...
    assert_eq!(diagonals, vec![2], "Position 1 should have position 2 in its diagonals");
...
fn test_diagonal_calculation_3x3() {
    ...
    assert_eq!(diagonals, vec![3, 5], "Position 4 should have positions 3 and 5 in its diagonals (all at distance 2)");
