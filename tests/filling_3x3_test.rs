...
fn test_filling_3x3_with_diagonal_check() {
    ...
    // Find the [3,3] child
    let ortho_3x3 = children
        .iter()
        .find(|o| o.dims() == &vec![3, 3])
        .cloned()
        .expect("Should have [3,3] child");
    ...
    loop {
        ...
        println!(
            "'and' in payload: {}, 'and' in forbidden: {}, 'and' in completions: {}",
        ...
        let token_to_add = if and_is_completion {
            and_idx
        } else {
            completions[0]
        };
