...
fn main() {
    ...
    let (interner1, changed1, frontier1, impacted1, processed1) = fold::process_text(
        "a b c",
        None,
        &mut seen_ids,
        &mut optimal_ortho,
    ...
    let (interner2, changed2, frontier2, impacted2, processed2) = fold::process_text(
        "a d",
        Some(interner1),
        &mut seen_ids,
        &mut optimal_ortho,
